        ...
        <div className="flex items-start shadow-sm py-8 px-6 w-full justify-around">
            <div className="flex justify-around gap-y-2 w-full">
                ...
                <span className='flex items-center'>
                    ...
                    <a href={lodging.plan} target="_blank" className='flex items-center  text-cyan-500 background-transparent font-bold uppercase px-4 py-[6px] text-xs outline-none focus:outline-none rounded-md hover:bg-cyan-500 hover:text-white ml-3 box-border mr-1 -mb-1 ease-linear transition-all duration-150'>
                        Suivre
