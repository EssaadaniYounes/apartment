...
const Statistics = () => {
    ...
    return (
        ...
        <div className='m-4'>
            ...
            <div className='w-auto md:w-[500px] flex flex-col items-center mt-4 relative rounded-md shadow-md overflow-x-auto bg-blue-50'>
                <h1 className='p-4 bg-blue-300 text-xs md:text-sm font-semibold text-white min-w-full'>Nombre Propriétés achetés cette année par mois</h1>
...
const ClientsBox = ({ clients }) => {
    return (
        <div className='w-[240px] h-22 flex items-center justify-between px-4 bg-orange-400 rounded-md shadow-sm p-2'>
...
const ApartmentsBox = ({ apartments }) => {
    return (
        <div className='w-[240px] h-22 flex  items-center justify-between px-4 bg-blue-400 rounded-md shadow-sm p-2'>
            <h1 className='flex items-center text-sm md:text-base lg:text-lg font-semibold text-white'>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
const ApartmentsBoughts = ({ apartments }) => {
    ...
    console.log(width);
    return (
        <div className='w-[240px] h-22  px-4 bg-orange-500 rounded-md shadow-sm p-2'>
...
const PaymentsBox = ({ payments }) => {
    return (
        <div className='w-[240px] flex items-center justify-between h-22  px-4 bg-green-500 rounded-md shadow-sm p-2'>
