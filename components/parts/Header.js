...
function Header() {
    const { user, setShowNotifications, showNotifications, notifications } = useUserContext();
    return (
        <div className="bg-gray-50 shadow-md text-gray-700 h-[60px] w-full z-20 flex items-center px-12 justify-start gap-6 flex-row-reverse">
            ...
            <div className='relative cursor-pointer text-sm' onClick={() => setShowNotifications(!showNotifications)}>
