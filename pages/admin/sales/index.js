...
function index({ dataSales, dataUser }) {
    ...
    const permission = dataUser.roles.permissions.ventes;
    const columns = [
        {
            name: "#",
        ...
        },
        {
            ...
            cell: row => <div className="flex items-center gap-2">
                {
                    can(permission, 'delete') && <button onClick={() => deleteSale(row.id)}>
                ...
                {
                    can(permission, 'read') && <Link href={`/admin/sales/sale/${row.id}`}>
                ...
                {
                    can(dataUser.roles.permissions.paiments, 'create') && <Link href={`/admin/sales/sale/payments/${row.id}`}>
    ...
    return (
        <>
            ...
            <div className="px-4 sm:px-8 py-4 shadow-sm w-full relative">
                ...
                <TablesHeader to={can(permission, 'create') && '/admin/sales/add'} title='Liste de ventes' />
